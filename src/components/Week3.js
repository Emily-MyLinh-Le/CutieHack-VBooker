    ...
    return(
        ...
        <Card  centered ='true'>
          ...
          <Card.Body>
            ...
            <Button href="/voting" variant="secondary">Book a session</Button>
          </Card.Body>
        </Card>
        
        <Card  centered ='true'>
        <Card.Header>Fantasy</Card.Header>
      ...
      <Card  centered ='true'>
          <Card.Header>Horror</Card.Header>
        ...
        <Card  centered ='true'>
          <Card.Header>Romance</Card.Header>
